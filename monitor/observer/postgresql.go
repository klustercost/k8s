...
func (p *Postgresql) InsertPod(pod_name, namespace string, record_time time.Time, used_mem, used_cpu int64, owner string, node_name string) error {

	_, err := p.DB.Exec("INSERT INTO klustercost.tbl_pods(pod_name, namespace, record_time, used_mem, used_cpu, owner, node_name)	VALUES($1, $2, $3, $4, $5, $6, $7)",
		pod_name, namespace, record_time, used_mem, used_cpu, owner, node_name)
	if err != nil {
		klog.Error(err)
		return err
	}
